...
const Home = () => {
  return (
    <main className="flex min-w-screen min-h-screen xs:p-2 md:p-10">
      <Note cancel=".footer .a" properties="bg-yellow-100" cornerProperties="bg-yellow-200">
        ...
        <small className="small md:text-xl xs:text-base cursor-default ">Anyway, <a className="a text-blue-500" href="mailto:alejoivanrojas@gmail.com">email</a> me if you have any suggestions</small>
