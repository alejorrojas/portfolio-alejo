  ...
  return (
    <html lang="en">
        ...
        <body className="bg-radial-pattern">
          <nav className=' w-screen top-0- md:pt-10 md:pr-32 xs:pt-5 xs:pr-10  mb-5 flex justify-between items-center'>
             <Link href="/" className={`${itim.className} xs:text-sm  md:text-xl pl-5 ml-4 hover:text-blue-400 transition duration-100 ease-in-out`} >Home</Link>
             <a target="_blank" href="https://www.linkedin.com/in/alejorrojas/" className='flex items-center'>
                ...
                <h2 className={`${itim.className} md:text-l xs:text-sm  ml-4 hover:text-blue-400 transition duration-100 ease-in-out`}>Alejo Rojas</h2>
             </a>
          </nav>
          {children}
        </body>
