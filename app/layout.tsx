    ...
    <html lang="en">
        ...
        <body className="bg-radial-pattern">
          <nav className=' w-screen top-0- md:pt-10 md:pr-32 xs:pt-5 xs:pb-5 xs:pr-10  mb-5 flex justify-between items-center'>
             <Link href="/" className={`${itim.className} xs:text-xl  md:text-2xl pl-5 ml-4 hover:text-gray-500 transition duration-100 ease-in-out`} >Home</Link>
                <a target="_blank" href="https://www.linkedin.com/in/alejorrojas/" className='flex items-center'>
                    <Image src="/avatar.jpeg" width="100" height="100" alt='Avatar' className='md:w-16 xs:w-12 rounded-full shadow-lg ring-2 ring-blue-400 hover:ring-blue-200 hover:ring-2  hover:shadow-sm hover:shadow-blue-500 transition duration-700 ease-in-out'/>
